...
namespace IndieGabo.HandyTools.Utils.Extensions
{
    ...
    {
        /// <summary>
        /// Alters the Vector3 values to signs defining -1, 0 or 1.
        /// </summary>
        ...
        /// <param name="vector"></param>
        /// <returns></returns>
        public static Vector3 CenterInUnit(this Vector3 vector)
        {
            return new Vector3(Mathf.FloorToInt(vector.x) + 0.5f, Mathf.FloorToInt(vector.y) + 0.5f, Mathf.FloorToInt(vector.z) + 0.5f);
        }
        /// <summary>
