...
namespace IndieGabo.HandyTools.Utils.Extensions
{
    ...
    {
        /// <summary>
        /// Rotates the Transform towards the target considering X and Y axis only
        /// </summary>
        /// <param name="subject"></param>
        /// <param name="target"></param>
        /// <returns></returns>
        public static Quaternion RotateTowards2D(this Transform subject, Transform target)
        {
            return subject.RotateTowards2D(target.position);
        }
        ...
        /// <returns></returns>
        public static Quaternion RotateTowards2D(this Transform subject, Vector2 targetPosition)
        {
            return subject.RotateTowards2D((Vector3)targetPosition);
        }
        ...
        /// <param name="targetPosition"></param>
        /// <returns></returns>
        public static Quaternion RotateTowards2D(this Transform subject, Vector3 targetPosition)
        {
            Vector2 direction = (targetPosition - subject.position).normalized;
