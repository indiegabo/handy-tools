...
namespace IndieGabo.HandyTools.Utils.Extensions
{
    ...
    {
        public static string FirstUpperThenLower(this string input) =>
            input switch
            {
        ...
        /// <summary>
        /// Computes a hash for the given string, using the FNV-1a algorithm.
        /// </summary>
        /// <param name="input">The string to hash.</param>
        /// <returns>The hash value.</returns>
        /// <remarks>
        /// This algorithm is designed to be fast while maintaining a good distribution of hash values.
        /// </remarks>
