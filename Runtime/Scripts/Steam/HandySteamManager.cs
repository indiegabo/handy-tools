...
namespace IndieGabo.HandyTools.SteamModule
{
    ...
    public class HandySteamManager : HandyBehaviour
    {
        ...
        /// </summary>
        public static bool SupportsCurrentPlatform
        {
            get
            {
#if !DISABLESTEAMWORKS
        ...
        {
            if (UnityEngine.Object.FindAnyObjectByType<HandySteamManager>(FindObjectsInactive.Include) != null)
            {
                return;
            }

            new GameObject("SteamManager", typeof(HandySteamManager));
        }
        ...
        protected virtual void Awake()
        {
            ...
            try
            {
                ...
                else if (SteamAPI.RestartAppIfNecessary(AppId_t.Invalid))
                {
                    Application.Quit();
                    return;
                }
