...
{
    /// <summary>
    /// Stores editor-facing metadata for one registered animation bus event
    /// type.
    /// </summary>
    public sealed class AnimatorBusEventMetadata
    {
        #region Initialization

        /// <summary>
        /// Creates metadata for one registered animation bus event type.
        /// </summary>
        /// <param name="eventType">Concrete event type.</param>
        /// <param name="path">Stable logical path.</param>
        /// <param name="displayName">Human-readable display name.</param>
        /// <param name="description">Human-readable description.</param>
        public AnimatorBusEventMetadata(
            Type eventType,
            string path,
            string displayName,
            string description
