...
{
    /// <summary>
    /// Stores the tunable dash values used by the CCPro example.
    /// </summary>
    [CreateAssetMenu(fileName = "DashStats", menuName = "HandyTools/FSM/CCPro/Stats/Dash")]
    public class DashStats : FSMStatsAsset
    {
        #region Inspector
